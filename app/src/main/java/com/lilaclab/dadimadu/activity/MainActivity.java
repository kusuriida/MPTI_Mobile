...
extends AppCompatActivity {
    ...
    private void renderLowStock(List<Produk> products) {
        ...
        for (Produk produk : products) {
            ...
            view.setText((CharSequence)(produk.namaProduk + " (" + produk.ukuranKemasan + ")\nStok tersisa: " + produk.stok + " item  (min. " + produk.minimumStok + ")"));
            ...
            view.setPadding(this.dp(14), this.dp(10), this.dp(14), this.dp(10));
            view.setLineSpacing((float)this.dp(3), 1.0f);
