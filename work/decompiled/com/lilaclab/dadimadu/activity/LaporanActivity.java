...
extends AppCompatActivity {
    ...
    private void loadReport() {
        ...
        AppDatabase.databaseWriteExecutor.execute(() -> {
            ...
            this.runOnUiThread(() -> {
                ...
                this.txtRingkasan.setText((CharSequence)("Pemasukan: " + FormatHelper.rupiah((double)pemasukan) + "\nPengeluaran: " + FormatHelper.rupiah((double)pengeluaran) + "\nLaba/Rugi: " + FormatHelper.rupiah((double)(pemasukan - pengeluaran))));
    ...
    private void renderChart(double pemasukan, double pengeluaran) {
        ...
        this.chartKeuangan.setData((ChartData)data);
    ...
    private void renderReports(List<StockReportItem> stok, List<PenjualanProdukItem> penjualan, String periodeLabel) {
        ...
        for (StockReportItem item : stok) {
            this.addCard("\ud83d\udce6 " + item.namaProduk, item.ukuranKemasan + " \u2022 Stok " + item.stok + " \u2022 Minimum " + item.minimumStok + "\nNilai modal stok: " + FormatHelper.rupiah((double)item.nilaiStok));
        }
