 ...
 *  com.lilaclab.dadimadu.activity.TambahTransaksiActivity$SaveResult
...
extends AppCompatActivity {
    ...
    private void bindViews() {
        ...
        this.edtOngkir.addTextChangedListener((TextWatcher)new /* Unavailable Anonymous Inner Class!! */);
    ...
    private void loadInitialData() {
        AppDatabase.databaseWriteExecutor.execute(() -> {
            ...
            List pelanggan = this.db.pelangganDao().getAll();
            ...
            this.runOnUiThread(() -> {
                ...
                ArrayAdapter nameAdapter = new ArrayAdapter((Context)this, 17367050, names);
                this.edtNamaPelanggan.setAdapter((ListAdapter)nameAdapter);
    ...
    private void simpanTransaksi() {
        List selectedItems = this.produkAdapter.getSelectedItems();
            ...
            try {
                this.db.runInTransaction(() -> {
                    ...
                    for (DetailTransaksi detail : details) {
                        int changed = this.db.produkDao().reduceStock(detail.idProduk, detail.qty);
    ...
    static /* synthetic */ void access$000(TambahTransaksiActivity x0) {
        x0.updateTotal();
    }
}
