...
public interface ProdukDao {
    @Insert(onConflict=1)
    public long insert(Produk var1);

    @Update
    public void update(Produk var1);

    @Delete
    public void delete(Produk var1);
    ...
    public List<Produk> search(String var1);

    @Query(value="SELECT * FROM produk WHERE id_produk = :idProduk LIMIT 1")
    public Produk getById(int var1);
    ...
    public List<PenjualanProdukItem> getPenjualanProduk(String var1);
}
